...
import ApiKeys from '../components/pageComponents/startupComponents/apiKeys';
...
const orderConfig = ['welcomeScreen', 'tutorial', 'apiKeys', 'themes', 'notifications', 'unsupported', 'changelog'];
...
function Startup(props) {
    ...
    } else if (currentOrder == 'apiKeys') {
        currentWindow = <ApiKeys></ApiKeys>
