                ...
                <div id="main">
                    <div id="topbar" className={this.state.showSidebar ? 'sidebarOn' : 'sidebarOff'}>
                        <div id="topHeader">
                            ...
                            <div id="toolbar">
                                <button className="bigThemedButton" onClick={() => { this.openTool('focussession') }} id="startSession" data-intro="Here, you can start a focus session with any amount of minutes and you can use the spotify integration. Note that the focus session WILL work even when the computer is asleep (it checks the difference between dates and doesn't just subtract it every second)">Start a focus session</button>
